...
class TestBadKeepAdults(unittest.TestCase):
    def test_bad_keep_adults(self):
        ...
        self.assertListEqual(actual.collect(), expected.collect(), msg="Bad test succeed")
...
class TestAddZipcode(unittest.TestCase):
    def test_add_zipcode(self):
        clients = spark.createDataFrame([
            ...
            Row(zip="91540", name='Rick', age="12", city="MENNECY"),
            Row(zip="75001", name='Bertrand', age="68", city="PARIS"),
            Row(zip="20001", name='Jules', age="39", city="AJACCIO"),
            Row(zip="20200", name="Lara", age="19", city="BASTIA")
        ])
        ...
        expected = spark.createDataFrame([
            ...
            Row(zip="20001", name='Jules', age="39", city="AJACCIO", departement="2A"),
            Row(zip="20200", name='Lara', age="19", city="BASTIA", departement="2B")
        ])
...
class TestJobs(unittest.TestCase):
    ...
    def test_jobs2(self):
        clean_df = spark.createDataFrame([
            ...
            Row(zip="91440", name='Gisl̬ne', age="43", city="ORMOY", departement="91")
        ])
